import { DefaultDraftInlineStyle, EditorState, Modifier, AtomicBlockUtils, RichUtils, SelectionState, DefaultDraftBlockRenderMap, getDefaultKeyBinding, KeyBindingUtil, convertFromRaw, convertToRaw, CompositeDecorator, Editor } from 'draft-js';
...
var getComponentWrapper = function getComponentWrapper(Wrapped, wrapperProps) {
  var Wrapper = function Wrapper(props) {
    return (// flowlint inexact-spread:off
      React.createElement(Wrapped, _extends({}, props, wrapperProps))
    );
  };
...
function (_Component) {
  ...
  _createClass(DraftailEditor, [{
    ...
    value: function render() {
      ...
      }), this.renderSource(), React.createElement(ListNestingStyles, {
        max: maxListNesting
      }));
    }
  }]);
